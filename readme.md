...
- [ScanDoc] - Scan and sign documents, and convert photos into scanned PDF documents.
...
- [document-scanner] - Document scanner built with Python and OpenCV (open source).
